...
public class GangwonActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    static final String TAG = "GangwonActivityTAG";
    ...
    //도시
    private String mCityStudy = "gangwonStudy";
    //리사이클러뷰 구성
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSearchEditText = findViewById(R.id.gangwon_et_search); //검색
        mMessageRecyclerView = findViewById(R.id.gangwon_rev_message); //채팅메세지들 리사이클러뷰


        findViewById(R.id.gangwon_tv_write).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GangwonActivity.this, WriteActivity.class);
        ...
        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.gangwon_swipe_layout);
        mSwipeRefreshLayout.setOnRefreshListener(this);


        mMessageList = new ArrayList<>();
        mMessageAdapter = new MessageAdapter(mMessageList, getApplicationContext(), GangwonActivity.this);
    ...
    public void setDrawer(){
        //드로어,메뉴
        mDrawerLayout = findViewById(R.id.gangwon_drawer_layout);
