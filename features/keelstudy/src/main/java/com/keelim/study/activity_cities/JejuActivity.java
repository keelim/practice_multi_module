...
public class JejuActivity extends AppCompatActivity  implements SwipeRefreshLayout.OnRefreshListener {
    static final String TAG = "JejuActivityTAG";
    ...
    //도시
    private String mCityStudy = "jejuStudy";
    //리사이클러뷰 구성
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSearchEditText = findViewById(R.id.jeju_et_search); //검색
        mMessageRecyclerView = findViewById(R.id.jeju_rev_message); //채팅메세지들 리사이클러뷰


        findViewById(R.id.jeju_tv_write).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(JejuActivity.this, WriteActivity.class);
        ...
        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.jeju_swipe_layout);
        mSwipeRefreshLayout.setOnRefreshListener(this);


        mMessageList = new ArrayList<>();
        mMessageAdapter = new MessageAdapter(mMessageList, getApplicationContext(), JejuActivity.this);
    ...
    public void setDrawer(){
        //드로어,메뉴
        mDrawerLayout = findViewById(R.id.jeju_drawer_layout);
