...
public class JeonbukActivity extends AppCompatActivity  implements SwipeRefreshLayout.OnRefreshListener {
    static final String TAG = "JeonbukActivityTAG";
    ...
    //도시
    private String mCityStudy = "jeonbukStudy";
    //리사이클러뷰 구성
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSearchEditText = findViewById(R.id.jeonbuk_et_search); //검색
        mMessageRecyclerView = findViewById(R.id.jeonbuk_rev_message); //채팅메세지들 리사이클러뷰


        findViewById(R.id.jeonbuk_tv_write).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(JeonbukActivity.this, WriteActivity.class);
        ...
        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.jeonbuk_swipe_layout);
        mSwipeRefreshLayout.setOnRefreshListener(this);


        mMessageList = new ArrayList<>();
        mMessageAdapter = new MessageAdapter(mMessageList, getApplicationContext(), JeonbukActivity.this);
    ...
    public void setDrawer(){
        //드로어,메뉴
        mDrawerLayout = findViewById(R.id.jeonbuk_drawer_layout);
