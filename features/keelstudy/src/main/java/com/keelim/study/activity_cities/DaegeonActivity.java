...
public class DaegeonActivity extends AppCompatActivity  implements SwipeRefreshLayout.OnRefreshListener {
    static final String TAG = "DaegeonActivityTAG";
    ...
    //도시
    private String mCityStudy = "daegeonStudy";
    //리사이클러뷰 구성
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daegeon);
        setTitle("대전지역");

        loadShared(); //프로필정보받아옴
        setDrawer(); //드로어 세팅

        mSearchEditText = findViewById(R.id.daegeon_et_search); //검색
        mMessageRecyclerView = findViewById(R.id.daegeon_rev_message); //채팅메세지들 리사이클러뷰


        findViewById(R.id.daegeon_tv_write).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DaegeonActivity.this, WriteActivity.class);
        ...
        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.daegeon_swipe_layout);
        mSwipeRefreshLayout.setOnRefreshListener(this);


        mMessageList = new ArrayList<>();
        mMessageAdapter = new MessageAdapter(mMessageList, getApplicationContext(), DaegeonActivity.this);
    ...
    public void setDrawer(){
        //드로어,메뉴
        mDrawerLayout = findViewById(R.id.daegeon_drawer_layout);
