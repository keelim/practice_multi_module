...
object Dep {
    object GradlePlugin {
        ...
        const val service =  "com.google.gms:google-services:4.3.4"
        const val perf = "com.google.firebase:perf-plugin:1.3.4"
        const val crash = "com.google.firebase:firebase-crashlytics-gradle:2.3.0"
    ...
    object Firebase{
        const val bom = "platform(\"com.google.firebase:firebase-bom:26.1.0\")"
        ...
        const val ui_database =  "com.firebaseui:firebase-ui-database:7.1.0"
    }
}