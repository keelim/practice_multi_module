...
public class ChungbukActivity extends AppCompatActivity  implements SwipeRefreshLayout.OnRefreshListener {
    static final String TAG = "ChungbukActivityTAG";
    ...
    //도시
    private String mCityStudy = "chungbukStudy";
    //리사이클러뷰 구성
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSearchEditText = findViewById(R.id.chungbuk_et_search); //검색
        mMessageRecyclerView = findViewById(R.id.chungbuk_rev_message); //채팅메세지들 리사이클러뷰


        findViewById(R.id.chungbuk_tv_write).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ChungbukActivity.this, WriteActivity.class);
        ...
        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.chungbuk_swipe_layout);
        mSwipeRefreshLayout.setOnRefreshListener(this);


        mMessageList = new ArrayList<>();
        mMessageAdapter = new MessageAdapter(mMessageList, getApplicationContext(), ChungbukActivity.this);
    ...
    public void setDrawer(){
        //드로어,메뉴
        mDrawerLayout = findViewById(R.id.chungbuk_drawer_layout);
