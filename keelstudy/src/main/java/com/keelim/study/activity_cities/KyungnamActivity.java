package com.keelim.study.activity_cities;
...
import com.keelim.study.activity.LoginActivity;
import com.keelim.study.activity.PhotoZoomActivity;
import com.keelim.study.activity.ProfileActivity;
import com.keelim.study.activity.WriteActivity;
import com.keelim.study.adapter.MessageAdapter;
...
public class KyungnamActivity extends AppCompatActivity  implements SwipeRefreshLayout.OnRefreshListener {
    static final String TAG = "KyungnamActivityTAG";
    ...
    //도시
    private String mCityStudy = "kyungnamStudy";
    //리사이클러뷰 구성
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kyungnam);
        setTitle("경남지역");

        loadShared(); //프로필정보받아옴
        setDrawer(); //드로어 세팅

        mSearchEditText = findViewById(R.id.kyungnam_et_search); //검색
        mMessageRecyclerView = findViewById(R.id.kyungnam_rev_message); //채팅메세지들 리사이클러뷰


        findViewById(R.id.kyungnam_tv_write).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(KyungnamActivity.this, WriteActivity.class);
        ...
        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.kyungnam_swipe_layout);
        mSwipeRefreshLayout.setOnRefreshListener(this);


        mMessageList = new ArrayList<>();
        mMessageAdapter = new MessageAdapter(mMessageList, getApplicationContext(), KyungnamActivity.this);
    ...
    public void setDrawer(){
        //드로어,메뉴
        mDrawerLayout = findViewById(R.id.kyungnam_drawer_layout);
