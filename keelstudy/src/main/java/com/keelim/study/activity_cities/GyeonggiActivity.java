...
public class GyeonggiActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    static final String TAG = "GyeonggiActivityTAG";
    ...
    //도시
    private String mCityStudy = "gyeonggiStudy";
    //리사이클러뷰 구성
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSearchEditText = findViewById(R.id.gyeonggi_et_search); //검색
        mMessageRecyclerView = findViewById(R.id.gyeonggi_rev_message); //채팅메세지들 리사이클러뷰


        findViewById(R.id.gyeonggi_tv_write).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GyeonggiActivity.this, WriteActivity.class);
        ...
        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.gyeonggi_swipe_layout);
        mSwipeRefreshLayout.setOnRefreshListener(this);


        mMessageList = new ArrayList<>();
        mMessageAdapter = new MessageAdapter(mMessageList, getApplicationContext(), GyeonggiActivity.this);
    ...
    public void setDrawer(){
        //드로어,메뉴
        mDrawerLayout = findViewById(R.id.gyeonggi_drawer_layout);
