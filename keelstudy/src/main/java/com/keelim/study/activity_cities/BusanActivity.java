...
public class BusanActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    static final String TAG = "BusanActivityTAG";
    ...
    //도시
    private String mCityStudy = "busanStudy";
    //리사이클러뷰 구성
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSearchEditText = findViewById(R.id.busan_et_search); //검색
        mMessageRecyclerView = findViewById(R.id.busan_rev_message); //채팅메세지들 리사이클러뷰


        findViewById(R.id.busan_tv_write).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BusanActivity.this, WriteActivity.class);
        ...
        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.busan_swipe_layout);
        mSwipeRefreshLayout.setOnRefreshListener(this);


        mMessageList = new ArrayList<>();
        mMessageAdapter = new MessageAdapter(mMessageList, getApplicationContext(), BusanActivity.this);
    ...
    public void setDrawer(){
        //드로어,메뉴
        mDrawerLayout = findViewById(R.id.busan_drawer_layout);
